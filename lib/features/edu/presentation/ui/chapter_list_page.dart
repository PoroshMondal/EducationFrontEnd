...
import 'package:bjit_education/features/edu/presentation/bloc/remote/remote_edu_bloc.dart';
import 'package:bjit_education/features/edu/presentation/bloc/remote/remote_edu_state.dart';
...
class ChapterListPage extends StatelessWidget {
  ...
  _buildBody(BuildContext context) {
    ...
    return BlocBuilder<RemoteeduBloc, RemoteeduState>(
      builder: (_, state) {
        if (state is RemoteeduChapterListLoading) {
          return const Center(child: CupertinoActivityIndicator());
        }
        if (state is RemoteeduChapterListError) {
          return const Center(child: Icon(Icons.refresh));
        }
        if (state is RemoteeduChapterListDone) {
